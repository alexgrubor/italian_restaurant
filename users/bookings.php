        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center text-uppercase">
                ...
                <li class="breadcrumb-item"><a
                        href="<?php echo APPURL; ?>/users/booking.php?id=<?php echo $_SESSION['user_id']; ?>">Bookings</a>
                </li>
            </ol>
        </nav>
    </div>
        ...
        <table class="table">
            ...
            <tbody>
                <?php if (sizeof($bookings) > 0): ?>
                    <?php foreach ($bookings as $booking): ?>
                        <tr>
                            ...
                            <?php if ($booking->status == "Confirmed"): ?>
                                <td><a href="<?php echo APPURL; ?>/users/review.php" class="btn btn-success text-white">Review us
                                </td>
                            <?php endif; ?>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    ...
                    <div class="alert alert-success text-white bg-success">There is no bookings made by you</div>
                <?php endif; ?>
