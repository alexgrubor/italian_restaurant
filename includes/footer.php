            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        <h4 class="section-title  text-start text-primary fw-normal mb-4">Company</h4>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Berlinplatz 2, 20000 Berlin</p>
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+012 345 67890</p>
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>info@restaurant.com</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <h4 class="section-title  text-start text-primary fw-normal mb-4">Opening</h4>
